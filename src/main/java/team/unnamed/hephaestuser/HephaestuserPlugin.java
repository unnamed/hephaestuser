...
import team.unnamed.hephaestuser.command.ModelCommand;
import team.unnamed.hephaestuser.command.integration.CommandModuleImpl;
import team.unnamed.hephaestuser.integration.IntegrationManager;
import team.unnamed.hephaestuser.integration.citizens.CitizensIntegration;
import team.unnamed.hephaestuser.integration.citizens.CitizensSubCommand;
import team.unnamed.hephaestuser.listener.DisguisedPlayerJoinListener;
import team.unnamed.hephaestuser.loader.ModelFileLoader;
import team.unnamed.hephaestuser.task.ModelAnimateTask;

@SuppressWarnings("unused") // instantiated via Reflection by server
public final class HephaestuserPlugin extends JavaPlugin {
