package team.unnamed.hephaestuser.command;
...
import team.unnamed.hephaestuser.HephaestuserProvider;
...
public final class ModelCommand implements CommandClass {
    ...
    public void disguise(final @Sender @NotNull Player player, final @NotNull Model model) {
        ...
        player.getPersistentDataContainer().set(HephaestuserPlugin.DISGUISED_AS_KEY, PersistentDataType.STRING, model.name());
